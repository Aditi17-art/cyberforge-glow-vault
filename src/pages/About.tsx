...
const values = [
  {
    icon: Award,
    title: "Excellence",
    desc: "Industry-leading certifications and rigorous methodologies.",
  },
  {
    icon: ShieldCheck,
    title: "Integrity",
    desc: "Confidential, transparent, and ethical at every step.",
  },
  {
    icon: Users,
    title: "Partnership",
    desc: "We work alongside your team — not as a black box vendor.",
  },
  {
    icon: TrendingUp,
    title: "Innovation",
    desc: "Always ahead of evolving threats with modern tooling.",
  },
];
...
const certifications = [
  ...
  },
  {
    icon: ShieldAlert,
    title: "SOC 2 Type II",
    desc: "Audited controls for security & privacy.",
  },
  {
    icon: Cloud,
    title: "AWS Partner",
    desc: "Certified cloud security specialists.",
  },
];
...
const differentiators = [
  {
    ...
    desc: "Engagements kick off in days, not months.",
  },
  {
    icon: Globe2,
    title: "Global delivery",
    desc: "Specialists across 4 continents, 24/7 coverage.",
  },
  {
    icon: Zap,
    title: "Attacker mindset",
    desc: "Real adversary simulation, not checkbox audits.",
  },
  {
    icon: Lock,
    title: "Zero-leak guarantee",
    desc: "Encrypted reporting, strict NDAs, secure-by-default ops.",
  },
];
      ...
      <section className="relative section-padding overflow-hidden">
        ...
        <div className="container relative mx-auto text-center max-w-3xl">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-bold leading-tight">
            ...
            <span className="text-gradient">digital defense</span>
          </h1>
          <p className="mt-6 text-muted-foreground text-lg leading-relaxed">
            We make world-class cybersecurity, software quality and digital
            craftsmanship accessible to every modern business — from disruptive
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-5 leading-tight">
              A team of{" "}
              <span className="text-gradient">offensive thinkers</span>{" "}
              defending what matters most
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              For over a decade, our specialists have safeguarded financial
              institutions, healthcare systems, government agencies and
              high-growth tech companies. We don't just check boxes — we think
              like attackers, build resilient systems and equip your team to
      ...
      <section className="section-padding bg-cyber-surface/30 border-y border-primary/10">
        <div className="container mx-auto grid md:grid-cols-2 gap-6">
          <div className="glass-card p-8 group transition-all duration-300 hover:scale-[1.02] hover:shadow-glow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To empower every organization with proactive, intelligent and
              accessible cybersecurity — turning security from a cost center
          ...
          <div className="glass-card p-8 group transition-all duration-300 hover:scale-[1.02] hover:shadow-glow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed">
              A digital world where businesses innovate fearlessly — protected
              by defense systems that adapt as fast as the threats they face.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="mt-4 text-muted-foreground">
              From regulated finance to fast-moving startups — we tailor defense
              to your domain.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl glass-card p-10 md:p-14 text-center">
            ...
            <div className="relative">
              ...
              <p className="font-display text-xl md:text-2xl leading-relaxed text-foreground/90">
                "Cyberforge didn't just find our vulnerabilities — they rebuilt
                our security culture. The most professional engagement we've run
                in a decade."
              </p>
        ...
        <div className="container mx-auto">
          <div className="relative overflow-hidden rounded-3xl glass-card p-10 md:p-16 text-center">
            ...
            <div className="relative">
              <h2 className="font-display text-3xl md:text-5xl font-bold">
                Want to work with{" "}
                <span className="text-gradient">Cyberforge?</span>
              </h2>
              <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
                Let's talk about how we can secure, build and scale your
                business — together.
              </p>
